...
import com.bookstore.project.domain.Role;
import com.bookstore.project.domain.User;
import com.bookstore.project.domain.dto.RegisterDTO;
import com.bookstore.project.repository.RoleRepository;
...
public class UserService {
    ...
    public User handelSaveUser(User user) {
        User anric = this.userRepository.save(user);
        System.out.println(anric);
        return anric;
    }
    ...
    // spring jpa check email exist(repository)
