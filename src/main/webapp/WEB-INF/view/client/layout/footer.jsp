...
<!-- Footer Start -->
<div class="container-fluid bg-footer text-white-50 footer pt-5 mt-5" style="background-color: #2c3e50;">
        ...
        <div class="row g-5">
            ...
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
                    ...
                    <a class="text-muted mb-2" href="#">Giới thiệu</a>
                    <a class="text-muted mb-2" href="#">Chính sách bảo mật</a>
                    <a class="text-muted" href="#">Điều khoản dịch vụ</a>
                </div>
            </div>
            <div class="col-lg-3 col-md-6">
                <div class="d-flex flex-column text-start footer-item">
...
<!-- Copyright Start -->
<div class="container-fluid bg-footer copyright py-4" style="background-color: #34495e;">
    <div class="container">
        <div class="row">
