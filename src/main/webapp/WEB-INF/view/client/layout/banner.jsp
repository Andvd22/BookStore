...
<!-- Hero Start -->
<div class="container-fluid py-5 mb-5 hero-header" style="background-color: #f4f4f9;">
    <div class="container py-5">
        <div class="row g-5 align-items-center">
            <div class="col-md-12 col-lg-7">
                <h4 class="mb-3" style="color: #a98357;">Sách Chính Hãng - Nguồn Tri Thức</h4>
                <h1 class="mb-5 display-3" style="color: #5a8f7b;">Thế giới sách<br /> Giá ưu đãi tuyệt vời</h1>
            </div>
                ...
                <div id="carouselId" class="carousel slide position-relative" data-bs-ride="carousel">
                    <div class="carousel-inner" role="listbox">
                        <div class="carousel-item active rounded">
                            ...
                            <a href="#" class="btn px-4 py-2" style="background-color: #6c757d; color: #fff; border-radius: 0.5rem;">Tiểu thuyết</a>
                        </div>
                        <div class="carousel-item rounded">
                            ...
                            <a href="#" class="btn px-4 py-2" style="background-color: #6c757d; color: #fff; border-radius: 0.5rem;">Khoa học</a>
                        </div>
                        <div class="carousel-item rounded">
                            ...
                            <a href="#" class="btn px-4 py-2" style="background-color: #6c757d; color: #fff; border-radius: 0.5rem;">Sách giáo khoa</a>
                        </div>
                    </div>
